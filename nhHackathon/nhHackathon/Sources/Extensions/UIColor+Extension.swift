...
extension UIColor {
    ...
    @nonobjc class var salmon: UIColor {
        return UIColor(red: 1.0, green: 139.0 / 255.0, blue: 118.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var aquaMarine: UIColor {
        return UIColor(red: 74.0 / 255.0, green: 205.0 / 255.0, blue: 189.0 / 255.0, alpha: 1.0)
    }
    ...
    @nonobjc class var veryLightPinkThree: UIColor {
        return UIColor(red: 1.0, green: 235.0 / 255.0, blue: 231.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var duckEggBlue: UIColor {
        return UIColor(red: 209.0 / 255.0, green: 242.0 / 255.0, blue: 238.0 / 255.0, alpha: 1.0)
    }
